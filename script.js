...
const navMenu = document.getElementById("nav-menu") // Declare navMenu variable
const mobileMenu = document.getElementById("mobile-menu") // Declare mobileMenu variable
...
if (contactForm) {
  ...
  if (formFields.name) {
    formFields.name.addEventListener(
      "blur",
      debounce(() => {
  ...
  if (formFields.email) {
    formFields.email.addEventListener(
      "blur",
      debounce(() => {
